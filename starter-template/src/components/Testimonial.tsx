...
const Testimonial = (
  ...
  //   const [quoteScope, quoteEntranceAnimation] = useAnimate();
  const {
    scope: quoteScope,
  ...
  //   const [citeScope, citeEntranceAnimation] = useAnimate();
  ...
  return (
    ...
    >
      ...
      <blockquote className="md:col-span-3">
        <div
          className="text-3xl md:text-5xl mt-8 md:mt-0 lg:text-6xl"
          ref={quoteScope}
        >
          <span>&ldquo;</span>
          {quote}
