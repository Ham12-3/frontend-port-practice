        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {projects.map(({ name, image }) => (
            <a
              href="#"
              key={name}
              className="border-t py-6 md:py-8 border-stone-400 border-dotted flex flex-col last:border-b lg:py-10 relative group/project"
            >
              ...
              <div className="relative">
                ...
                <div className="mt-8 md:mt-0 flex justify-between items-center md:grid md:[grid-template-columns:1fr_300px_max-content] md:gap-8">
                  ...
                  <div className="relative">
                    <div className="absolute aspect-video w-full top-1/2 -translate-y-1/2 opacity-0 scale-90 group-hover/project:opacity-100 group-hover/project:scale-100 transition-all duration-500 z-10 lg:group-hover/project:scale-110">
                      <Image
                        src={image}
                        alt={`${name} image`}
                        className="size-full object-cover"
